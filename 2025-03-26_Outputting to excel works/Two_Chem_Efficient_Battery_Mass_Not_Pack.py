...
def Two_Chem_Efficient_Battery_Mass_Not_Pack(battery_1, battery_2, req_energy, peak_power_req, max_pack_V_allowed, min_pack_V_allowed, max_mass, peak_charge_power_req):
    ...
    while check_max_V == 0:# and check_mass == 1 and check_min_V == 1 and check_energy == 1:
        ...
        while check_mass == 0:
            if no_battery_1_parallel > no_battery_2_parallel and \
                ...
                return success, no_battery_1_series, no_battery_1_parallel, no_battery_2_series, no_battery_2_parallel, energy, 0, pack_mass, 0
